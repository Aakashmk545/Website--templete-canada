                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto">
                            ...
                            <Nav.Link href="">  <Link to="/gallary" > Gallary </Link></Nav.Link>
                            <Nav.Link href="">  <Link to="/link" > Parallax </Link></Nav.Link>
                            <Nav.Link href="">  <Link to="/Contect" > Contect </Link></Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Container>    
            </Navbar>
